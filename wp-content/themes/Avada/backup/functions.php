...
//add_action('woocommerce_add_to_cart', 'set_thumbnail');
//
//function set_thumbnail ()
//{
//    
//$phpVar =  $_COOKIE['imgurl'];    
//if (isset($_COOKIE['imgurl']))
//{   
////$productimg = "http://php.twilightsoftwares.com:9998/murals/wp-content/uploads/2017/08/stock-photo-pizza-pepperoni-this-picture-is-perfect-for-you-to-design-your-restaurant-menus-visit-my-page-583585405.jpg";
//$productimg = $_COOKIE['imgurl'];
//$post_id = 282;
...
//    $file = $upload_dir['path'] . '/'.'closify-uploads'.'/' . $filename;
//else
//    $file = $upload_dir['basedir'] . '/'.'closify-uploads'.'/' . $filename;
