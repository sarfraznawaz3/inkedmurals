...
LOCK TABLES `wp_woocommerce_bundled_items` WRITE;
/*!40000 ALTER TABLE `wp_woocommerce_bundled_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_woocommerce_bundled_items` ENABLE KEYS */;
UNLOCK TABLES;
