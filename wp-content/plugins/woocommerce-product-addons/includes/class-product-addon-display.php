...
class Product_Addon_Display {
	...
	public function addon_scripts() {
		...
		$params = array(
			...
			'i18n_addon_total'             => __( 'Options:', 'woocommerce-product-addons' ),
			'i18n_grand_total'             => __( 'Total:', 'woocommerce-product-addons' ),
