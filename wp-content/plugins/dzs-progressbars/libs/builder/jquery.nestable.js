...
;(function($, window, document, undefined)
{
    ...
    var defaults = {
            ...
            listClass       : 'dd-list',
            itemClass       : 'dd-item',
            dragClass       : 'dd-dragel dzsprg-builder-con ',
    ...
    Plugin.prototype = {
        ...
        dragStop: function(e){
            ...
            //console.info(el, el[0].outerHTML);
            ...
            if (this.hasNewRoot) {
                ...
                this.el.find('ol').eq(0).append(aux);
            }


            console.info('dragStop' , this.hasNewRoot, this.dragRootEl, this.dragRootEl.options, this.el, this.dragEl)
            this.reset();
        ...
        dragMove: function(e){
            ...
            //console.info("HIER POINT OF NO RETURN", _pe, (!_pe.length || !_pe.hasClass(opt.itemClass)), !_pe.length,'should be item class - ', opt.itemClass );
            ...
            //console.warn(!mouse.dirAx, isNewRoot, isEmpty)
            if (!mouse.dirAx || isNewRoot || isEmpty) {
                // check if groups match if dragging over new root

                console.info('isNewRoot - ',isNewRoot,'opt.group - ',opt.group,pointElRoot.data('nestable-group'), opt.group!== pointElRoot.data('nestable-group'));
                if (isNewRoot && opt.group !== pointElRoot.data('nestable-group')) {
                    return;
                }
                console.info("HIER3 POINT OF NO RETURN");
                // check depth limit
                ...
                var before = e.pageY < (_pe.offset().top + _pe.height() / 2);
                    ...
                    console.info('before - ', before, 'parent - ',parent);
