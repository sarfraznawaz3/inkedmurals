...
//            console.info(window.dzsp_translate_close2);
            ...
            function init(){
                ...
                if(isNaN(Number(o.design_item_thumb_height))==false){
                    ...
                    design_item_thumb_height_dynamic = design_item_thumb_height <= 1 && design_item_thumb_height > 0;
                }else{
            ...
            function reinit(pargs){
                ...
                _items.children('.zfolio-item:not(.inited)').each(function(){
                    ...
                    if (o.item_link_thumb_con_to == 'link') {
                        aux += ' <a class="the-feature-con';
                    }else{
                        aux += ' <div class="the-feature-con';
                    }
                    ...
                    if (o.item_link_thumb_con_to == 'link') {
                        ...
                        if(_t.attr('data-bigimage')){
                            ...
                            aux += ' href="' + _t.attr('data-bigimage') + '"';
                        }
                    }
                    aux+='>';
                    ...
                    if(o.design_item_thumb_just_use_img=='on'){
                        ...
                        _thumbCon.prependOnce('<div class="the-feature" style="background-image: url('+_t.attr('data-thumbnail')+');"></div>');
                    }
