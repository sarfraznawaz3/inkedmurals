...
//                            console.info(animprop, animprops[animprop]);
                            ...
                            if(animprop=='background' || animprop=='background-color'){
                    ...
                    if(_t.hasClass('progress-bar-item--repeater')){
                        ...
                        var auxsNr = 100/ Number(auxs.replace('%',''));
...
//                            console.info('ceva');
                            ...
                            var aux24 = parseInt(perc /100 * maxnr, 10);


                            if(o.thousand_separate_character){
                                if(String(aux24).length>3){

                                    var iterations23 = Math.round( (String(aux24).length-2) / 3);
                                    //console.info(aux24, iterations23);

                                    _cach_final_str = '';
                                    _cach_temp_str = String(aux24);
                                    ...
                                    aux24 = _cach_final_str;

                                }

                            }

                            //console.info('aux24 - ',aux24);

                            val = val.replace('{{percmaxnr}}', aux24);
                            ...
                            //console.warn('animprop - ',animprop);
...
//                                console.info(perc, animprops);
                    ...
                    if(_t.hasClass('progress-bar-item--repeater')){
                        ...
                        var len = Math.floor(animPerc*ilen)
                        console.error('len - ',len);
                        for (var i5=0;i5<len;i5++){

                            _t.children('.repeater-item:not(".repeater-item--sample")').eq(i5).addClass('active');
                        }
