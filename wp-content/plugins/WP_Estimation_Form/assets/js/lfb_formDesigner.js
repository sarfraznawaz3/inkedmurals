...
function tld_updateFromSliderField(){
     var value = jQuery(this).val();
        if (value > parseInt(jQuery(this).prev('.tld_slider').attr('data-max'))) {
            value = parseInt(jQuery(this).prev('.tld_slider').attr('data-max'));
        }
        if (value < parseInt(jQuery(this).prev('.tld_slider').attr('data-min'))) {
            value = parseInt(jQuery(this).prev('.tld_slider').attr('data-min'));
        }
        jQuery(this).prev('.tld_slider').slider('value', parseInt(value));
