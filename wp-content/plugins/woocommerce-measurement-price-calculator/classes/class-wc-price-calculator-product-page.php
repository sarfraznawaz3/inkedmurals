...
class WC_Price_Calculator_Product_Page {
	...
	public function price_per_unit_html( $price_html, $product ) {
		...
		return '<span class="wc-measurement-price-calculator-price">' . $price_html . '</span>';
	}
	...
	public function enqueue_frontend_scripts() {
		...
		wp_enqueue_script( 'wc-price-calculator', wc_measurement_price_calculator()->get_plugin_url() . '/assets/js/frontend/wc-measurement-price-calculator.min.js', array( 'jquery', 'jquery-cookie' ) );
