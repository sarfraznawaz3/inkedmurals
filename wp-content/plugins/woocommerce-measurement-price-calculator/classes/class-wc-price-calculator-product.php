...
class WC_Price_Calculator_Product {
	...
	public static function get_dimension_measurement( $product, $measurements ) {
		 ...
		 */
		$measurement_value = apply_filters( 'wc_measurement_price_calculator_measurement_dimension', SV_WC_Product_Compatibility::get_prop( $product, $measurement_name ), $product, $measurement );
	...
	public static function get_area_measurement( $product ) {
		...
		$measurement = null;
		$length      = SV_WC_Product_Compatibility::get_prop( $product, 'length' );
		$width       = SV_WC_Product_Compatibility::get_prop( $product, 'width' );
	...
	public static function get_surface_area_measurement( $product ) {
		...
		$length      = SV_WC_Product_Compatibility::get_prop( $product, 'length' );
		$width       = SV_WC_Product_Compatibility::get_prop( $product, 'width' );
		$height      = SV_WC_Product_Compatibility::get_prop( $product, 'height' );
	...
	public static function get_volume_measurement( $product ) {
		...
		if ( ! empty( $area ) && is_numeric( $height ) ) {
			...
			$dimension_measurement = new WC_Price_Calculator_Measurement( $dimension_unit, SV_WC_Product_Compatibility::get_prop( $product, 'height' ) );
	...
	public static function get_weight_measurement( $product ) {
		...
		$weight = SV_WC_Product_Compatibility::get_prop( $product, 'weight' );
